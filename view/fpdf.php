...
$listelivraison= (new livraisonC())->afficherlivraisons();
...
function Header()
{
    ...
    $this->Cell(50);
    // Titre
    $this->Cell(80,10,'la liste des livraisons',1,0,'C');
    // Saut de ligne
    $this->Ln(50);
}
...
$pdf = new PDF();
 $pdf->AliasNbPages();
// Titres des colonnes
$header = array('IDlivraison','IDproduit', 'Nomcat', 'IDclient','NUMclient');
