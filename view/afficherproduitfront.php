                     ...
                     <img src="../i/<?= $produit['image'] ?>"height="200" width="200">
                       ...
                       <?php }?>
                        ...
                        <br><br>
                          ...
                          <a type="button" class="btn sm action-2 f-16" href="add_panier.php?Id_produit=<?php echo $produit["Id_produit"]; ?>&&prix_total=<?php echo $produit["Prix"]; ?>" >Ajouter au panier</a>
