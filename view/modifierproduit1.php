...
if (isset($_POST['NomP']) && isset($_POST['DateA']) && isset($_POST['Description1']) && isset($_POST['Genre'])&& isset($_POST['Couleur'])&& isset($_POST['Taille'])&& isset($_POST['poids']) && isset($_POST['Prix'])&& isset($_POST['Quantite']) && isset($_POST['image'])   ) {
    $produit = new produit($_POST['NomP'], $_POST['DateA'], $_POST['Description1'], $_POST['Genre'], $_POST['Couleur'], $_POST['Taille'], $_POST['poids'], $_POST['Prix'], $_POST['Quantite'], $_POST['image'],$id);
               ...
               Liste des Produits
                ...
                <table class="table custom-table">
                    ...
                    <tr>
                        ...
                        <td>  <input type="text" name="NomP" value="<?= $result['NomP'] ?>">  </td></tr>
                        <tr>  <th scope="col">date</th><td>  <input type="text" name="DateA" value="<?= $result['DateA'] ?>">  </td></tr>
                       <tr>  <th scope="col">description</th> <td>  <input type="text" name="Description1" value="<?= $result['Description1'] ?>">  </td></tr>
                        <?php
                      ...
                      <tr><th scope="col">genre</th>  <td>
                       ...
                       <tr>  <th scope="col">Couleur</th><td>  <input type="text" name="Couleur" value="<?= $result['Couleur'] ?>"> </td> </tr>
                        <tr>  <th scope="col">Taille</th><td> <input type="text" name="Taille" value="<?= $result['Taille'] ?>"> </td></tr>
                        <tr> <th scope="col">poids</th><td>  <input type="text" name="poids" value="<?= $result['poids'] ?>"> </td></tr>
                        <tr> <th scope="col">Prix</th><td>  <input type="text" name="Prix" value="<?= $result['Prix'] ?>"> </td></tr>
                        <tr>    <th scope="col">Quantite</th> <td>  <input type="text" name="Quantite" value="<?= $result['Quantite'] ?>"> </td></tr>
                       <tr> <th scope="col">image</th> <td>  <input type="file" name="image" value="<?= $result['image'] ?>"> </td></tr>
                        <tr><td><div class="container-contact100-form-btn"><input type="submit" name="modifier" class="contact100-form-btn" value="modifier"> </div></td></tr>
