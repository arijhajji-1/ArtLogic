...
<!--===============================================================================================-->
 ...
 <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLayouts6" aria-expanded="false" aria-controls="collapseLayouts7">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Reclamation
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseLayouts6" aria-labelledby="headingOne1" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
...
<select  name="pr" class="form-control">
     ...
     <?php endforeach; ?>       
                ...
                <div class="wrap-input100 bg1 rs1-wrap-input100">
                    ...
                    <input class="input100" type="date"  name="dateDebut" min="<?php echo date('Y-m-d'); ?>" >
                </div>
                <div class="wrap-input100 bg1 rs1-wrap-input100">
                    <span class="label-input100">Date fin promotion</span>
                    <input class="input100" type="date"  name="dateFin"  min="<?php echo date('Y-m-d'); ?>">
                </div>
<div class="wrap-input100 bg1 rs1-wrap-input100">
