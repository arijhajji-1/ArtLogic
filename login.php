...
<form action="verification.php" method="POST" class="bg-light mx-auto mw-430 radius10 pt-40 px-50 pb-30">
    <h2 class="mb-40 small text-center" data-aos-duration="600" data-aos="fade-down" data-aos-delay="0">Connexion</h2>
...
<br>
    ...
    <input type="submit" id='submit' value='LOGIN' class="mt-25 btn action-1 w-full" >
</form>
</div>
<!-- Footer 1 -->
