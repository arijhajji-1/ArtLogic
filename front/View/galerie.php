...
<section class="form_1 pt-120 pb-120">
    ...
    <div class="container px-xl-0">
        <form action="" method = "POST" class="bg-light mx-auto mw-430 radius10 pt-40 px-50 pb-30">
            ...
            <div class="mb-20 input_holder" >
                <h4 class="mb-40 small text-center"><?=$Produit['description'] ?></h4>
            </div>
            <div class="mb-20 input_holder" >
                <h4 class="mb-40 small text-center"><?=$Produit['quantite'] ?></h4>             </div>
            <div class="mb-20 input_holder">
                <h4 class="mb-40 small text-center"><?=$Produit['prix'] ?></h4>             </div>
